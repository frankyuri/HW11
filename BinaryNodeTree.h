...
protected:
   ...
   int getMaximumHelper(BinaryNode<ItemType>* subTreePtr) const;
   int getHighestFullLevelHelper(BinaryNode<ItemType>* subTreePtr) const;
...
//////////////////////////////////////////////////////////////
template<class ItemType>
int BinaryNodeTree<ItemType>::getHighestFullLevelHelper(BinaryNode<ItemType>* subTreePtr) const
{
   if (subTreePtr == nullptr)
      return 0;

   if ( subTreePtr->getLeftChildPtr() != nullptr && subTreePtr->getRightChildPtr() != nullptr ) {
	   int left =  getHighestFullLevelHelper(subTreePtr->getLeftChildPtr());
	   int right = getHighestFullLevelHelper(subTreePtr->getRightChildPtr());
...
template<class ItemType>
int BinaryNodeTree<ItemType>::getMaximumHelper(BinaryNode<ItemType>* subTreePtr) const
{
   if (subTreePtr == nullptr)
      return  INT_MIN;

   int max = subTreePtr->getItem();
   int left =  getMaximumHelper(subTreePtr->getLeftChildPtr());
   int right = getMaximumHelper(subTreePtr->getRightChildPtr());
...
template<class ItemType>
int BinaryNodeTree<ItemType>::getMaximum() const
{
   return getMaximumHelper( rootPtr ) ;
}  // end add

template<class ItemType>
int BinaryNodeTree<ItemType>::getHighestFullLevel() const
{
   return getHighestFullLevelHelper( rootPtr ) ;
}  // end add
//////////////////////////////////////////////////////////////
//      Public Traversals Section
//////////////////////////////////////////////////////////////
